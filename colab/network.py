...
def vfn_rl(x, variable_dict, global_feature=None, h=None, c=None, embedding_dim=1000):
    ...
    print(' vfn_rl  default graph', tf.get_default_graph())
    ## conv1
    ...
    print(' conv1W shape = ', conv1W.shape)
    print(' conv1b shape = ', conv1b.shape)
    ...
    print(' conv2W shape = ', conv2W.shape)
    print(' conv2b shape = ', conv2b.shape)
    ...
    print(' conv3W shape = ', conv3W.shape)
    ...
    print(' conv4W shape = ', conv4W.shape)
    ...
    print(' conv5W shape = ', conv5W.shape)
    ...
    print(' fc6W shape = ', fc6W.shape)
    print(' fc6b shape = ', fc6b.shape)
    ...
    for k  in variable_dict.keys() :
        print( ' variable_dict key =' , k)

    #print( 'Variable W ' , variable_dict["W"]  )

    #sys.exit(0)
    #Ww = variable_dict["W"]
    #score = tf.matmul(feature_vec, Ww )
    ...
    print(' fc3b shape = ', fc3b.shape)

    fc3 = tf.nn.relu_layer(fc2, fc3W, fc3b)

    print(' lstm.weight_ih shape = ', variable_dict['lstm.weight_ih'].T.shape)
    print(' lstm.bias_ih shape = ', variable_dict['lstm.bias_ih'].shape)
    ...
    print(' action1w shape = ', action1w.shape)
    print(' action1b shape = ', action1b.shape)
